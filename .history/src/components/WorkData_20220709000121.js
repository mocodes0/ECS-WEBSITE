    ...
    <div>
      ...
      <div className="grid my-10 justify-center gap-5 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
        ...
        <div className="bg-[#ffffff1a] border-[#131022]">
          <img
            className="w-full h-64"
            src="https://images.pexels.com/photos/160994/family-outdoor-happy-happiness-160994.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            alt="family"
          />
          <div>
            <div className="p-3 border-b border-[#131022]">
        ...
        <div className="bg-[#ffffff1a] border-[#131022]">
          <img
            className="w-full h-64"
            src="https://images.pexels.com/photos/1337977/pexels-photo-1337977.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
            alt="family"
          />
          <div>
            <div className="p-3 border-b border-[#131022]">
